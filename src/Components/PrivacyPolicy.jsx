  ...
  return (
    <div>
      ...
      <p>
        ...
        operates the https://stores.allotment.pro website (the “Service”).This
      ...
      <h2>USE OF DATA</h2>
      <p>Allotment Stores uses the collected data for various purposes:</p>
      <ul></ul>
      ...
      <p>
        ...
        agreement to that transfer.Allotment Stores will take all steps
      ...
      <p>
        Allotment Stores may disclose your Personal Data in the good faith
        belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>
          To protect and defend the rights or property of Allotment Stores
        </li>
        <li>
